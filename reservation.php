    ...
    OR empty($_POST['checkin_date']) OR empty($_POST['destination'])) {
      ...
      if(date("Y-m-d")< $checkin_date){
        ...
        header("location: pay.php");
          ...
          echo "<script>alert('invalid date,Pick stsrting from tomorrow');</script>";
        ...
        <div class="col-lg-12">
          <form id="reservation-form"  method="POST" role="search" action="reservation.php?id=<?php echo $id; ?>">
            <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset>
                    <input type="hidden" value="<?php echo $getCity->name; ?>" name="destination" class="destination" placeholder="Ex. +xxx xxx xxx" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-12">                        
                  <fieldset>
